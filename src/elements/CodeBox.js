...
export default function CodeBox({ content, parse = false }) {
  ...
  return (
    <code className="font-mono my-2 mx-4 block h-fit max-w-full overflow-x-auto whitespace-pre rounded border-solid border-neutral-500 bg-neutral-900 text-vsGreen placeholder:text-vsGreen">
      {codeFileName && (
