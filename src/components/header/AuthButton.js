...
export default function AuthButton() {
  ...
  const className =
    'bg-transparent text-zinc-300 rounded h-full hover:border-black hover:text-black hover:bg-zinc-300 focus:border-black focus:text-black focus:bg-zinc-300 border-solid border-current col-start-5 whitespace-nowrap';
